...
$mail->addAddress('help@setgoi.com', 'Sanaka Educational Trust Group Of Institutions');
$mail->addAddress('sayanti@sysbean.com' , 'Sanaka Educational Trust Group Of Institutions');
