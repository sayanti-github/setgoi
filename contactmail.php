...
$mail->addAddress('info@setgoi.com', 'Sanaka Educational Trust Group Of Institutions');
$mail->addAddress('sanakaeducationaltrust@gmail.com' , 'Sanaka Educational Trust Group Of Institutions');
...
if (!$mail->send()) {
    ...
    echo 'Email Sent';
    header('Location: ./contactus -2.html?msg=success', TRUE, 302); exit;
}
